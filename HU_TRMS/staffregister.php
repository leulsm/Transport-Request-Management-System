        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="form-container">
                    ...
                    <form class="form-horizontal" method="POST" action="demp1.php">
        ...
        <select id="inputState" class="form-select">
            ...
            <option>CHBS</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="si"placeholder="Staff ID">
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                        <button class="btn btn-primary m-4 signup" name="submit">Create Account</button>
                        </div>

                        <span class="signin-link">Already have an account? Click here to <a href="stafflogin.php">Login</a></span>
                    </form>
                    <?php
